...
window.exportAuditLogsToCsv = function() {
    ...
    csvContent += "Timestamp,IP Address,User,Action,Target,Status,Message Details\r\n";
    ...
    link.setAttribute("download", `jnoc_audit_logs_${new Date().toISOString().slice(0, 10)}.csv`);
